  ...
  return (
    <Fragment>
      ...
      <section className="movies-layout page-container pb-20">
        <h2 className="text-2xl fonbol">Now playing</h2>
        <div className="movie-list grid grid-cols-4 gap-10">
          <div className="movie-card p-3 rounded-lg text-white bg-slate-800">
            <img
              src="https://nld.mediacdn.vn/2019/4/25/3515432-endgamedek-15561710302491765206118.jpg"
              alt=""
              className="w-full h-[250px] object-cover rounded-lg"
            />
            <h3 className="text-xl font-bold">Spiderman: Homecoming</h3>
