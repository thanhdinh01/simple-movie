...
function App() {
  return (
    <Fragment>
      ...
      <section className="banner page-container h-[500px] pb-20 border border-white">
      ...
      <section className="movies-layout page-container  text-white pb-20 border border-white">
